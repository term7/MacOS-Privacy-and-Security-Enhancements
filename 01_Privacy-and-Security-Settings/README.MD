...
07) Setup Firmware Password (relevant only for Intel based Macs)
08) Prevent Firmware Password Resets (relevant only for Intel based Macs)
09) Enable FileVault (Full Disk Encryption)
